return {
  ...
  config = function()
    ...
    kms("n", "<leader>sp", "<cmd>Telescope find_files theme=ivy<CR>", { desc = "Fuzzy [S]earch Files in [P]roject (cwd)" })
    kms("n", "<leader>m", "<cmd>Telescope frecency workspace=CWD theme=ivy<CR>", { desc = "Fuzzy [S]earch recent file[S]sssss" })
    ...
    kms("n", "<leader>sg", "<cmd>Telescope live_grep theme=ivy<CR>", { desc = "Fuzzy [S]earch strings with [G]rep in CWD" })
    ...
    kms('n', '<leader>sb', ':lua require("telescope.builtin").current_buffer_fuzzy_find()<CR>', { desc = "[S]earch [B]uffer" })
    kms('n', '<leader>/', ':lua require("telescope.builtin").current_buffer_fuzzy_find()<CR>', { desc = "[S]earch [B]uffer" })
